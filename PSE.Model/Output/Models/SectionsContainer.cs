...
namespace PSE.Model.Output.Models
{
    ...
    public sealed class SectionsContainer
    {
        ...
        public IOutputModel? Section30 { get; set; }
        ...
        public IOutputModel? Section140 { get; set; }
                ...
                foreach(IOutputModel section in sections)
                {
                    switch(section.SectionId) 
                    {
                        ...
                        case Enumerations.ManipolationTypes.AsSection020:
                            Section20 = section;
                            break;
                        case Enumerations.ManipolationTypes.AsSection030:
                            Section30 = section;
                            break;
                        ...
                        case Enumerations.ManipolationTypes.AsSection130:
                            Section130 = section;
                            break;
                        case Enumerations.ManipolationTypes.AsSection140:
                            Section140 = section;
                            break;
