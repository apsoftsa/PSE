...
namespace PSE.BusinessLogic
{
    ...
    public class ManipulatorSection090 : ManipulatorBase, IManipulator
    {
        ...
        public ManipulatorSection090(CalculationSettings calcSettings, CultureInfo? culture = null) : base(PositionClassifications.AZIONI_FONDI_AZIONARI, ManipolationTypes.AsSection090, culture) 
        {
                ...
                foreach (IDE ideItem in ideItems)
                {
                    ...
                    if (posItems != null && posItems.Any(flt => flt.CustomerNumber_2 == ideItem.CustomerNumber_2))
                    {
                        ...
                        foreach (POS posItem in posItems.Where(flt => flt.CustomerNumber_2 == ideItem.CustomerNumber_2))
                        {
                            ...
                            bondGreatThan5 = new ShareDetail()
                            {
                            ...
                            sectionContent.Subsection9010.Content.Add(bondGreatThan5);
