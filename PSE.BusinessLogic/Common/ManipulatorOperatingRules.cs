    ...
    public static class ManipulatorOperatingRules
    {
        ...
        static ManipulatorOperatingRules()
        {
            ...
            _sectionsBinding = new List<SectionBinding>()
            {
                ...
                //new SectionBinding(ManipolationTypes.AsSection16And17, "section16-17", "Funds", new List<PositionClassifications>() { PositionClassifications.BONDS_WITH_MATURITY_MINOR_EQUAL_1_YEAR, PositionClassifications.BONDS_WITH_MATURITY_MINOR_EQUAL_5_YEARS, PositionClassifications.BONDS_WITH_MATURITY_MAJOR_THAN_5_YEARS_OR_FUNDS }),
