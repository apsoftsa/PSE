    ...
    public static class ManipulatorOperatingRules
    {
        ...
        static ManipulatorOperatingRules()
        {
            ...
            _classificationPositions = new List<PositionClassification>()
            {
                ...
                new PositionClassification(PositionClassifications.CONTI_METALLO_METALLI_FONDI_METALLO, "ACCOUNT METALLO, METALLI, FONDI METALLO", 1),
            ...
            _sectionsBinding = new List<SectionBinding>()
            {
                ...
                new SectionBinding(ManipolationTypes.AsSection070, "section70", "Liquidity", new List<PositionClassifications>() { PositionClassifications.ACCOUNT,  PositionClassifications.SHORT_TERM_FUND }),
                //new SectionBinding(ManipolationTypes.AsSection070, "section70", "Short-term investments", new List<PositionClassifications>() { PositionClassifications.SHORT_TERM_FUND }),
                ...
                new SectionBinding(ManipolationTypes.AsSection080, "section80", "Bonds", new List<PositionClassifications>() { PositionClassifications.OBBLIGAZIONI_CON_SCADENZA_MINOR_OR_EQUAL_5_ANNI }),
                ...
                new SectionBinding(ManipolationTypes.AsSection090, "section90", "Shares", new List<PositionClassifications>() { PositionClassifications.AZIONI_FONDI_AZIONARI }),
                ...
                new SectionBinding(ManipolationTypes.AsSection110, "section110", "Others investments", new List<PositionClassifications>() { PositionClassifications.PRODOTTI_DERIVATI_SU_METALLI, PositionClassifications.PRODOTTI_DERIVATI, PositionClassifications.PRODOTTI_ALTERNATIVI_DIVERSI }),
                new SectionBinding(ManipolationTypes.AsSection100, "section100", "Metals", new List<PositionClassifications>() { PositionClassifications.CONTI_METALLO_METALLI_FONDI_METALLO }),
                new SectionBinding(ManipolationTypes.AsSection150, "section150", "Information Position", new List<PositionClassifications>() { PositionClassifications.MUTUI_IPOTECARI_E_CREDITI_DI_COSTRUZIONE, PositionClassifications.IMPEGNI_EVENTUALI }),
