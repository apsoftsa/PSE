    ...
    public class ManipulatorSection12 : ManipulatorBase, IManipulator
    {
        ...
        public override IOutputModel Manipulate(IList<IInputRecord> extractedData)
        {
            ...
            if (extractedData.Any(flt => flt.RecordType == nameof(IDE)) && extractedData.Any(flt => flt.RecordType == nameof(POS)))
            {
                ...
                IBondsMaturingLessThan5Years bondLessThan5;
                ISection12Content sectionContent;                
                ...
                foreach (IDE ideItem in ideItems)
                {
                    ...
                    {
                        sectionContent = new Section12Content();                        
                        foreach (POS posItem in posItems.Where(flt => flt.CustomerNumber_2 == ideItem.CustomerNumber_2))                        
                        {
                            ...
                            bondLessThan5 = new BondsMaturingLessThan5Years()
                            {
                            ...
                            sectionContent.BondsMaturingLessThan5Years.Add(bondLessThan5);
                            posItem.AlreadyUsed = true;
                        }
                        output.Content = new Section12Content(sectionContent);
                    }
                }
            }
            return output;
